...
export async function generateMetadata({
  ...
  if (!opp) {
    return { title: 'Không tìm thấy thông tin thực tập | Cơ Hội Việc Làm' };
  }

  return {
    title: `${opp.title} - ${opp.organization} | Thực tập sinh 2026`,
    description: opp.summary?.slice(0, 160) || 'Chương trình thực tập sinh và việc làm sinh viên chất lượng cao.',
  };
}
